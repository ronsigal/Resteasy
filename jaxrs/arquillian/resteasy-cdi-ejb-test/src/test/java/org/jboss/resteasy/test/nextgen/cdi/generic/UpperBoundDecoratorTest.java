...
public class UpperBoundDecoratorTest
{
   ...
   public static Archive<?> createTestArchive()
   {
      WebArchive war = ShrinkWrap.create(WebArchive.class, "resteasy-cdi-ejb-test.war")
            ...
            .addClasses(UpperBoundDecorator.class)
            .addAsWebInfResource("generic/upper_bound_beans.xml", "beans.xml");
   ...
   public void testUpperBoundDecorator() throws Exception
   {
      ...
      WebTarget target = ClientBuilder.newClient().target("http://localhost:8080/resteasy-cdi-ejb-test/rest/upperbound/decorators");
