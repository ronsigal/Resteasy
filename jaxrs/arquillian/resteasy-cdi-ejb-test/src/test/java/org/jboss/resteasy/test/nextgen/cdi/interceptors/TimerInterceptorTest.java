package org.jboss.resteasy.test.nextgen.cdi.interceptors;
...
public class TimerInterceptorTest
{
   @Inject Logger log;
	...
	public void testTimerInterceptor() throws Exception
	{
	   ...
	   // Schedule timer.
	   WebTarget target = ClientBuilder.newClient().target("http://localhost:8080/resteasy-cdi-ejb-test/rest/timer");
	   Response response = target.path("schedule").request().get();
