...
public class EJBTest
{
   ...
   public void testAsJaxRSResource() throws Exception
   {
      ...
      WebTarget target = ClientBuilder.newClient().target("http://localhost:8080/resteasy-ejb-test");
      Response response = target.path("create").request().post(Entity.entity(book1, Constants.MEDIA_TYPE_TEST_XML));
      log.info("Status: " + response.getStatus());
      assertEquals(200, response.getStatus());
      ...
      response = target.path("create").request().post(Entity.entity(book2, Constants.MEDIA_TYPE_TEST_XML));
      log.info("Status: " + response.getStatus());
      assertEquals(200, response.getStatus());
      ...
      // Retrieve first book.
      response = target.path("book/" + id1).request(Constants.MEDIA_TYPE_TEST_XML).get();
      log.info("Status: " + response.getStatus());
      assertEquals(200, response.getStatus());
      ...
      response = target.path("book/" + id2).request(Constants.MEDIA_TYPE_TEST_XML).get();
      log.info("Status: " + response.getStatus());
      assertEquals(200, response.getStatus());
      ...
      response = target.path("uses/4").request().get();
      log.info("Status: " + response.getStatus());
      assertEquals(200, response.getStatus());
      response.close();
      
      // Reset counter.
      response = target.path("reset").request().get();
      log.info("Status: " + response.getStatus());
