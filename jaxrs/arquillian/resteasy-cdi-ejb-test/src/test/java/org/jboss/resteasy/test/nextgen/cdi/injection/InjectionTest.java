...
public class InjectionTest
{
   ...
   public void testSessionScope() throws Exception
   {
      ...
      // Need to supply each request with a single ClientHttpEngine to maintain a single
      ...
      WebTarget target = client.target("http://localhost:8080/resteasy-cdi-ejb-test/rest/session");
