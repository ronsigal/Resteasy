package org.jboss.resteasy.test.nextgen.cdi.extension.bean;
...
public class BeanExtensionTest
{
   ...
   public void testBostonBeans() throws Exception
   {
      ...
      WebTarget target = ClientBuilder.newClient().target("http://localhost:8080/resteasy-extension-test/rest/extension/boston/");
