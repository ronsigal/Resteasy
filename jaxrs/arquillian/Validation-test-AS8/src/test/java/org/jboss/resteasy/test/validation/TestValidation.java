...
import org.jboss.resteasy.plugins.providers.validation.save.ResteasyViolationExceptionSave;
...
public class TestValidation
{
   ...
   @Path("/")
   public static class InterFaceTestSuper implements InheritenceInterface
   {
   ...
   @Path("/")
   public static class InterfaceTestSub extends InheritenceImplSuper
   {
...
//   @Ignore
   public void testFieldInvalid() throws Exception
   {
      ...
      Assert.assertTrue(entity instanceof ResteasyViolationExceptionSave);
      ResteasyViolationExceptionSave e = ResteasyViolationExceptionSave.class.cast(entity);
   ...
   public void testParameters() throws Exception
   {
      ...
      Assert.assertTrue(entity instanceof ResteasyViolationExceptionSave);
      e = ResteasyViolationExceptionSave.class.cast(entity);
      countViolations(e, 1, 0, 0, 0, 1, 0);
...
//      String cv = null;
   ...
   private void countViolations(ResteasyViolationExceptionSave e, int totalCount, int fieldCount, int propertyCount, int classCount, int parameterCount, int returnValueCount)
   {
   ...
   private ViolationsContainer<?> getViolationsContainer(ResteasyViolationExceptionSave e) throws NoSuchFieldException, IllegalAccessException
   {
	   Field container = ResteasyViolationExceptionSave.class.getDeclaredField("container");
