...
import org.jboss.resteasy.cdi.inheritence.BookSelectedAlternative;
...
public class AlternativeSelectedInheritanceTest
{
   ...
   public static Archive<?> createTestArchive()
   {
      WebArchive war = ShrinkWrap.create(WebArchive.class, "resteasy-cdi-ejb-test.war")
            ...
            .addClasses(Book.class, BookVanillaAlternative.class, BookSelectedAlternative.class, InheritanceResource.class)
            .addAsWebInfResource("inheritence/alternativeSelectedBeans.xml", "beans.xml");
   ...
   public void testAlternative() throws Exception
   {
      ...
      Builder request = ClientBuilder.newClient().target("http://localhost:8080/resteasy-cdi-ejb-test/rest/alternative/selected").request();
