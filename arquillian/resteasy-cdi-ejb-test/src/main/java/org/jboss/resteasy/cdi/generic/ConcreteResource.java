...
{  
   ...
   public Response testGenerics()
   {
      ...
      log.info(rawNested.getTypeArgument().toString());
      ...
      log.info(rawUpperBound.getTypeArgument().toString());
      ...
      log.info(rawLowerBound.getTypeArgument().toString());
      ...
      boolean result = true;
      if (!rawObject.getTypeArgument().equals(Object.class))
      {
         log.info("rawObject type argument class should be Object instead of " + rawObject.getTypeArgument());
         result = false;
      }
      ...
      if (!rawHierarchy.getTypeArgument().equals(Primate.class))
      {
         log.info("rawHierarchy type argument class should be Primate instead of " + rawHierarchy.getTypeArgument());
         result = false;
      }
      ...
      if (!rawNested.getTypeArgument().equals(Primate.class))
      {
         log.info("rawNested type argument class should be Primate instead of " + rawNested.getTypeArgument());
         result = false;
      }
      ...
      if (!rawUpperBound.getTypeArgument().equals(Primate.class))
      {
         log.info("rawUpperBound type argument class should be Primate instead of " + rawUpperBound.getTypeArgument());
         result = false;
      }
      ...
      if (!rawLowerBound.getTypeArgument().equals(Primate.class))
      {
         log.info("rawLowerBound type argument class should be Primate instead of " + rawLowerBound.getTypeArgument());
         result = false;
      }
