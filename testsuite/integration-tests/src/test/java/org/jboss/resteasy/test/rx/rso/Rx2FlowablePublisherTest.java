...
public class Rx2FlowablePublisherTest {
   ...
   public void testScheduledExecutorService () throws Exception {
...

      {
         ...
         ResteasyClient client = ((ResteasyClientBuilder) new ResteasyClientBuilderImpl().executorService(executor)).build();
   ...
   public void testGetTwoClients() throws Exception {
      ...
      ResteasyClient client1 = new ResteasyClientBuilderImpl().build();
      ...
      ResteasyClient client2 = new ResteasyClientBuilderImpl().build();
