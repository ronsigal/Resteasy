...
public class HelloWorldServer_gRPC {
   ...
   private void start() throws IOException {
      ...
      Runtime.getRuntime().addShutdownHook(new Thread() {
         ...
         public void run() {
            ...
            try {
               HelloWorldServer_gRPC.this.stop();
   ...
   public static void main(String[] args) throws IOException, InterruptedException {
      final HelloWorldServer_gRPC server = new HelloWorldServer_gRPC();
      server.start();
   ...
   static class GreeterImpl extends GreeterGrpc.GreeterImplBase {
      ...
      public void sayHello(HelloRequest req, StreamObserver<HelloReply> responseObserver) {
         try {
            System.out.println("entering HelloWorldServer_gRPC.sayHello()");
            HttpServletResponse response = getHttpServletResponse();
            Servlet servlet = ResteasyContext.getServlet("ResteasyServlet");
            servlet.service(getHttpServletRequest(req), response);
