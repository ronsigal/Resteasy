...
import org.jboss.resteasy.test.interceptor.resource.GZIPAnnotationInterceptor;
...
public class GZIPAnnotationTest {
   ...
   public static Archive<?> deploy() {
       ...
       war.addClass(GZIPAnnotationInterceptor.class);
   ...
   /**
    * @tpTestDetails Test that org.jboss.resteasy.annotations.ContentEncoding.ClientContentEncodingAnnotationFilter
   ...
   public void testGZIP() {
      ...
      target.register(GZIPAnnotationInterceptor.class);
