...
public class DefaultCharsetTest {
    ...
    public void testCharset() throws Exception {
       ...
       doTest("_default", "/_default", "/xml_nocharset", null);     // "resteasy.add.charset" not set, application/xml media type, charset not set
       doTest("_default", "/_default", "/xml_charset",   "UTF-16"); // "resteasy.add.charset" not set, application/xml media type, charset already set
       doTest("_default", "/_default", "/external",      null);     // "resteasy.add.charset" not set, application/xml-... media type, charset not set
       doTest("_default", "/_default", "/json",          null);     // "resteasy.add.charset" not set, application/json media type, charset not set
    }
