...
public class MultiValuedParamDefaultParamConverterFromStringClass implements Comparable<MultiValuedParamDefaultParamConverterFromStringClass> {
   ...
   public MultiValuedParamDefaultParamConverterFromStringClass(String s) {
      this.s = s;
   }
   
   public MultiValuedParamDefaultParamConverterFromStringClass() {
   ...
   static public MultiValuedParamDefaultParamConverterFromStringClass fromString(String s) {
      MultiValuedParamDefaultParamConverterFromStringClass tvoc = new MultiValuedParamDefaultParamConverterFromStringClass();
      tvoc.setS(s);
      return tvoc;
   }
}
