...
public class FileResource {
    ...
    public void upload(@QueryParam("path") String path, @Context Request request, @Suspended AsyncResponse response) {
//    public void upload(@QueryParam("path") String path, @Context Request request, @Context AsyncResponse response) {
