...
public class ResteasyDeploymentImpl implements ResteasyDeployment
{
   ...
   private void startInternal()
   {
      ...
      tracingText = config.getOptionalValue(ResteasyContextParameters.RESTEASY_TRACING_TYPE, Object.class).orElse(null);
      thresholdText = config.getOptionalValue(ResteasyContextParameters.RESTEASY_TRACING_THRESHOLD, Object.class).orElse(null);
