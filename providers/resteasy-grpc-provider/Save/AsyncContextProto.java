...
public class AsyncContextProto extends AbstractExecutionContext
{
...
//  protected AbstractExecutionContext(final SynchronousDispatcher dispatcher,final HttpRequest request,final HttpResponse response)
   ...
   AsyncContextProto(final ServletRequest servletRequest, final SynchronousDispatcher synchronousDispatcher, final HttpRequest httpRequest, final HttpResponse response)
   {
//      super(synchronousDispatcher, Servlet3AsyncHttpRequest.this, Servlet3AsyncHttpRequest.this.httpResponse);
      super(synchronousDispatcher, httpRequest, response);
   ...
   private class Servle3AsychronousResponse extends AbstractAsynchronousResponse implements AsyncListener
   {
      ...
      {
         super(AsyncContextProto.this.dispatcher, AsyncContextProto.this.request, AsyncContextProto.this.response);
      }
