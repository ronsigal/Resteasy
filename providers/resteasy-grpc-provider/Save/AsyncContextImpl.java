...
public class AsyncContextImpl implements AsyncContext {
    ...
    private final ServletRequest servletRequest; //x
    private final ServletResponse servletResponse; //x
    ...
    @Override
    public ServletRequest getRequest() { // x
        return servletRequest;
    }

    @Override
    public ServletResponse getResponse() { // X
        return servletResponse;
    }

    @Override
    public boolean hasOriginalRequestAndResponse() { //x
    ...
    @Override
    public void dispatch(final String path) {//x
        dispatch(servletRequest.getServletContext(), path);
    }

    @Override
    public void dispatch(final ServletContext context, final String path) {//x
    ...
    @Override
    public synchronized void complete() {//x
        if (complete) {
    ...
    @Override
    public void start(final Runnable run) {//x
    ...
    @Override
    public void addListener(final AsyncListener listener) {//x
        asyncListeners.add(new BoundAsyncListener(listener, servletRequest, servletResponse));
    }

    @Override
    public void addListener(final AsyncListener listener, final ServletRequest servletRequest, final ServletResponse servletResponse) {//x
        asyncListeners.add(new BoundAsyncListener(listener, servletRequest, servletResponse));
    }
    ...
    @Override
    public <T extends AsyncListener> T createListener(final Class<T> clazz) throws ServletException {//x
        try {
    ...
    @Override
    public synchronized void setTimeout(final long timeout) {//x
